document.addEventListener('DOMContentLoaded', () => {
  ...
  buttons.forEach(button => {
    button.addEventListener('click', () => {
      ...
      switch (buttonId) {
        case 'quarterback':
          responseContainer.innerHTML = '<div class="dynamic-response">Quarterback response</div>';
          break;
        case 'runningback':
          responseContainer.innerHTML = '<div class="dynamic-response">Running back response</div>';
          break;
        case 'widereceiver':
          responseContainer.innerHTML = '<div class="dynamic-response">Wide receiver response</div>';
          break;
        case 'tightend':
          responseContainer.innerHTML = '<div class="dynamic-response">Tight end response</div>';
          break;
        case 'overall':
          responseContainer.innerHTML = '<div class="dynamic-response">Overall response</div>';
          break;
        default:
